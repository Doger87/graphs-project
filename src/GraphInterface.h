...
public:
   ...
   virtual bool add(LabelType start,
                    LabelType end,
                    int edgeWeight) = 0;
   ...
   virtual bool remove(LabelType start,
                       LabelType end) = 0;
   
   /** Gets the weight of an edge in this graph.
    @param start  A label for the edge's first vertex.
    @param end    A label for the edge's second vertex.
    @return  The weight of the specified edge; negative if no such edge. */
   virtual int getEdgeWeight(LabelType start,
                             LabelType end) const = 0;
   ...
   /** Performs a depth-first search of this graph beginning at the given
    ...
    @param visit  A client-defined function that performs an operation on
                  each visited vertex label. */
   virtual void depthFirstTraversal(LabelType start,
                                    void visit(LabelType&)) = 0;
   ...
   /** Performs a breadth-first search of this graph beginning at the given
    ...
    @param visit  A client-defined function that performs an operation on
                  each visited vertex label. */
   virtual void breadthFirstTraversal(LabelType start,
                                      void visit(LabelType&)) = 0;
}; // end GraphInterface
#endif
